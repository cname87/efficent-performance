...
/* Set the path to the credentials for the storage-access service account */
process.env.GOOGLE_APPLICATION_CREDENTIALS = path.resolve(
  rootPath,
  'certs',
  'gcpStorage',
  'storage-access-08108540.json',
);

/* Name of the bucket on GCP Storage */
const bucketName = 'efficient-performance-gcp-environment-files';
